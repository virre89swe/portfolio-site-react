...
const ProjectModal = (props) => (
    <Modal
        isOpen={!!props.projectStatus}
        className="modal"
        closeTimeoutMS={200}
        contentLabel="Open Project"
        onRequestClose={props.closeProject}
    >
        <button onClick={props.closeProject}>Close</button>
        
        {props.projectStatus == 'projPortfolioNew' && 
            <div>
        ...
        {props.projectStatus == 'projBlackops4Stats' &&
            <div>
        ...
        {props.projectStatus == 'projBatt44Ladder' &&
            <div>
        ...
        {props.projectStatus == 'projClanMisery' &&
            <div>
        ...
        {props.projectStatus == 'projPortfolioOld' &&
            <div>
